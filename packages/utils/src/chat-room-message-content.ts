 ...
 * mention parse, unfurl, and markdown render. 40k matches Slack-like
 * workplace paste (research notes, ASCII tables). Assistant rows persist
 * via Prisma and are not subject to this Zod max.
 */
export const CHAT_ROOM_MESSAGE_CONTENT_MAX_LENGTH = 40_000;
