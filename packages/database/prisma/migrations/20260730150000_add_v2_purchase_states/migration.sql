...
-- Keep the history feed aligned with the new on-chain states:
-- WITHDRAW_AUTHORIZED behaves like RESULT_SUBMITTED, while REFUND_AUTHORIZED
-- behaves like REFUND_REQUESTED.
