...
> [!IMPORTANT]
> **PR titles MUST follow [Conventional Commit](https://www.conventionalcommits.org/en/v1.0.0/) syntax — this is enforced by the `Validate PR Title` CI check and a non-conforming title will fail the build.** This applies to *every* PR title, including ones auto-generated by AI/cloud agents. If you create or rename a PR, set the title yourself in this format rather than relying on a generated summary.
>
