...
const envSchemaConfig = z.object({
  ...
  NEXT_PUBLIC_BETTER_AUTH_SESSION_EXPIRES_IN: z
    .number()
    .min(1)
    .default(60 * 60 * 24 * 7), // 7 days
  NEXT_PUBLIC_BETTER_AUTH_SESSION_UPDATE_AGE: z
    .number()
    .min(1)
    .default(60 * 60 * 24), // 1 day
  NEXT_PUBLIC_BETTER_AUTH_SESSION_FRESH_AGE: z
    .number()
    .min(1)
    .default(60 * 5), // 5 minutes
  NEXT_PUBLIC_BETTER_AUTH_SESSION_COOKIE_CACHE_MAX_AGE: z
    .number()
    .min(0)
    .default(60 * 5), // 5 minutes

  // LinkedIn
  NEXT_PUBLIC_LINKEDIN_CLIENT_ID: z.string().nonempty(),

  // Apple
  NEXT_PUBLIC_APPLE_CLIENT_ID: z.string().nonempty(),

  // Microsoft
  NEXT_PUBLIC_MICROSOFT_CLIENT_ID: z.string().nonempty(),

  // Google
  NEXT_PUBLIC_GOOGLE_CLIENT_ID: z.string().nonempty(),

  // No-reply email
  NEXT_PUBLIC_NOREPLY_EMAIL: z.string().email(),
});
...
function validateEnv() {
  const parsedConfig = envSchemaConfig.safeParse({
    ...
    NEXT_PUBLIC_BETTER_AUTH_SESSION_EXPIRES_IN:
      process.env.NEXT_PUBLIC_BETTER_AUTH_SESSION_EXPIRES_IN,
    NEXT_PUBLIC_BETTER_AUTH_SESSION_UPDATE_AGE:
      process.env.NEXT_PUBLIC_BETTER_AUTH_SESSION_UPDATE_AGE,
    NEXT_PUBLIC_BETTER_AUTH_SESSION_FRESH_AGE:
      process.env.NEXT_PUBLIC_BETTER_AUTH_SESSION_FRESH_AGE,
    NEXT_PUBLIC_BETTER_AUTH_SESSION_COOKIE_CACHE_MAX_AGE:
      process.env.NEXT_PUBLIC_BETTER_AUTH_SESSION_COOKIE_CACHE_MAX_AGE,
    ...
    NEXT_PUBLIC_NOREPLY_EMAIL: process.env.NEXT_PUBLIC_NOREPLY_EMAIL,
