 ...
 */
export const deletePaymentSource = <ThrowOnError extends boolean = false>(options: Options<DeletePaymentSourceData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeletePaymentSourceResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
 ...
 */
export const patchPaymentSource = <ThrowOnError extends boolean = false>(options?: Options<PatchPaymentSourceData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).patch<PatchPaymentSourceResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
 ...
 */
export const postPaymentSource = <ThrowOnError extends boolean = false>(options?: Options<PostPaymentSourceData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostPaymentSourceResponse, unknown, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
