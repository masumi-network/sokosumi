...
import type { GetHealthData, GetHealthResponses, GetApiKeyStatusData, GetApiKeyStatusResponses, GetWalletData, GetWalletResponses, PatchWalletData, PatchWalletResponses, PostWalletData, PostWalletResponses, PostRevealDataData, PostRevealDataResponses, DeleteApiKeyData, DeleteApiKeyResponses, DeleteApiKeyErrors, GetApiKeyData, GetApiKeyResponses, GetApiKeyErrors, PatchApiKeyData, PatchApiKeyResponses, PatchApiKeyErrors, PostApiKeyData, PostApiKeyResponses, PostApiKeyErrors, GetPaymentData, GetPaymentResponses, GetPaymentErrors, PostPaymentData, PostPaymentResponses, PostPaymentErrors, PostPaymentSubmitResultData, PostPaymentSubmitResultResponses, PostPaymentSubmitResultErrors, PostPaymentAuthorizeRefundData, PostPaymentAuthorizeRefundResponses, PostPaymentAuthorizeRefundErrors, GetPurchaseData, GetPurchaseResponses, GetPurchaseErrors, PostPurchaseData, PostPurchaseResponses, PostPurchaseErrors, PostPurchaseRequestRefundData, PostPurchaseRequestRefundResponses, PostPurchaseRequestRefundErrors, PostPurchaseCancelRefundRequestData, PostPurchaseCancelRefundRequestResponses, PostPurchaseCancelRefundRequestErrors, PostPaymentResolveBlockchainIdentifierData, PostPaymentResolveBlockchainIdentifierResponses, PostPaymentResolveBlockchainIdentifierErrors, PostPurchaseResolveBlockchainIdentifierData, PostPurchaseResolveBlockchainIdentifierResponses, PostPurchaseResolveBlockchainIdentifierErrors, GetRegistryWalletData, GetRegistryWalletResponses, DeleteRegistryData, DeleteRegistryResponses, DeleteRegistryErrors, GetRegistryData, GetRegistryResponses, PostRegistryData, PostRegistryResponses, PostRegistryDeregisterData, PostRegistryDeregisterResponses, GetPaymentSourceData, GetPaymentSourceResponses, DeletePaymentSourceExtendedData, DeletePaymentSourceExtendedResponses, GetPaymentSourceExtendedData, GetPaymentSourceExtendedResponses, PatchPaymentSourceExtendedData, PatchPaymentSourceExtendedResponses, PostPaymentSourceExtendedData, PostPaymentSourceExtendedResponses, GetUtxosData, GetUtxosResponses, GetRpcApiKeysData, GetRpcApiKeysResponses } from './types.gen';
...
export const patchWallet = <ThrowOnError extends boolean = false>(options?: Options<PatchWalletData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).patch<PatchWalletResponses, unknown, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
...
export const postRevealData = <ThrowOnError extends boolean = false>(options?: Options<PostRevealDataData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostRevealDataResponses, unknown, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
...
export const postPaymentResolveBlockchainIdentifier = <ThrowOnError extends boolean = false>(options?: Options<PostPaymentResolveBlockchainIdentifierData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostPaymentResolveBlockchainIdentifierResponses, PostPaymentResolveBlockchainIdentifierErrors, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
...
export const postPurchaseResolveBlockchainIdentifier = <ThrowOnError extends boolean = false>(options?: Options<PostPurchaseResolveBlockchainIdentifierData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostPurchaseResolveBlockchainIdentifierResponses, PostPurchaseResolveBlockchainIdentifierErrors, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
...
export const deleteRegistry = <ThrowOnError extends boolean = false>(options?: Options<DeleteRegistryData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DeleteRegistryResponses, DeleteRegistryErrors, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
...
export const postRegistryDeregister = <ThrowOnError extends boolean = false>(options?: Options<PostRegistryDeregisterData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostRegistryDeregisterResponses, unknown, ThrowOnError>({
        security: [
            {
                name: 'token',
                type: 'apiKey'
