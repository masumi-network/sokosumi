...
export class UnifiedAgent {
    ...
    constructor(agent: Agent & {
        ...
        this.Author = {
            ...
            contactEmail: agent.overrideAuthorContactEmail ?? agent.onChainAuthorContactEmail,
            contactOther: agent.overrideAuthorContactOther ?? agent.onChainAuthorContactOther,
