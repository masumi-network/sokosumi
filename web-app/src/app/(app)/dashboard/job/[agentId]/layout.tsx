...
async function JobInnerLayout({
  ...
  return (
    <div className="flex flex-1 flex-col overflow-hidden p-4 lg:p-6 xl:p-8">
      <Header agent={agent} />
      <div className="mt-6 flex flex-1 flex-col items-center justify-center gap-4 overflow-hidden lg:flex-row">
        <JobTable />
        {children}
      </div>
    </div>
