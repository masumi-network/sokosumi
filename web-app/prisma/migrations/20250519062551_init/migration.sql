...
-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('AGENT_CONNECTION_FAILED', 'PAYMENT_NODE_CONNECTION_FAILED', 'PAYMENT_PENDING', 'PAYMENT_FAILED', 'INPUT_REQUIRED', 'PROCESSING', 'COMPLETED', 'FAILED', 'DISPUTE_REQUESTED', 'DISPUTE_RESOLVED', 'REFUND_REQUESTED', 'REFUND_RESOLVED', 'UNKNOWN');
