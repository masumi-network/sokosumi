...
-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('PAYMENT_PENDING', 'PAYMENT_FAILED', 'INPUT_REQUIRED', 'PROCESSING', 'COMPLETED', 'FAILED', 'DISPUTE_REQUESTED', 'DISPUTE_RESOLVED', 'REFUND_REQUESTED', 'REFUND_RESOLVED', 'UNKNOWN');
