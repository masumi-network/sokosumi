...
The first **paid** subscribe (Stripe self-serve or activating a real enterprise contract) makes Seats finite. Auto-assign Seats up to purchased capacity, **owner first**, then oldest remaining members. Overflow members become unseated until an admin assigns. They keep chat (including coworkers) and Task read; they cannot spend the pool or write Tasks. Paid unseated members do not get a free-tier 250 sidecar.
