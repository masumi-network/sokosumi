...
- `ttl` cannot be added without reopening this decision. Ably documents `ttl` **inside** the `notification` object, and the research doc records it as required for Web Push on Edge/WNS. A data-only payload has nowhere to put it.
