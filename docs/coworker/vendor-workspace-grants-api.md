...
| POST | `/v1/tasks/scheduled` | Atomic v2 scheduled creation; without a GRANTED grant, upserts a PENDING request and returns **403** `grant_required`; never parks work. |
