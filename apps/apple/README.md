...
| `Sokosumi/Chat/Composer` | Editing state and native text input |
| `Sokosumi/Chat/Rendering` | Markdown, code and thought presentation |
| `Sokosumi/Shared` | Participant avatar presentation |
