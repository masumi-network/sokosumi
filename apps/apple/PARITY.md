...
- Native highlighting checkpoint: 31 grammar choices and common fence aliases integrated; 206 Chat tests, Xcode app build/tests (including bundled query lookup), iOS 17 compilation and lint/format passed. Full registry, aliases/detection and remaining rich-text behavior are still incomplete.
