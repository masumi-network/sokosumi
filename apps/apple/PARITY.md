...
- Next implementation: shared read-budget follow-up (07b), before adding further background readers. Quick reactions (20b) can follow independently. Room search (23) and the documentation refresh (#4608) are merged.
