...
- Active slice: emoji reactions (20), branch `codex/apple-message-reactions`, draft [#4530](https://github.com/masumi-network/sokosumi/pull/4530), based on main after deletion #4498 merged. Reusing the existing Core toggle endpoint, realtime reaction patches and bundled emoji catalog; no API or dependency changes.
...
| 20 | Emoji reactions: picker, add/remove, counts, own selection, participant names and server-confirmed updates. | 07 | In review — [#4530](https://github.com/masumi-network/sokosumi/pull/4530) | [room-message-row.tsx](<../web/src/app/(app)/chat/components/room-message-row.tsx>), [rooms-client.tsx](<../web/src/app/(app)/chat/components/rooms-client.tsx>), [emoji-picker.tsx](<../web/src/components/chat/emoji-picker.tsx>) |
