...
- Active slice: message quotes (17), branch `codex/apple-message-quotes`, based on current main after Office preview #4473 merged. Local verification passed; draft [#4477](https://github.com/masumi-network/sokosumi/pull/4477). Reuses Core quote references for classic and streamed sends; no contract or dependency change.
...
| 17 | Quote a message in room/reply composer, preview/dismiss, submit quote reference, expand quoted content and jump to source. | 08, 10 | In review — [#4477](https://github.com/masumi-network/sokosumi/pull/4477) | [room-composer.tsx](<../web/src/app/(app)/chat/components/room-composer.tsx>), [room-message-row.tsx](<../web/src/app/(app)/chat/components/room-message-row.tsx>), [rooms-client.tsx](<../web/src/app/(app)/chat/components/rooms-client.tsx>) |
