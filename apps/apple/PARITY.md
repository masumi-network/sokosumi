...
- Active slice: message quotes (17), branch `codex/apple-message-quotes`, based on current main after Office preview #4473 merged. Local verification passed; draft PR pending. Reuses Core quote references for classic and streamed sends; no contract or dependency change.
...
| 17 | Quote a message in room/reply composer, preview/dismiss, submit quote reference, expand quoted content and jump to source. | 08, 10 | Implemented — draft PR pending | [room-composer.tsx](<../web/src/app/(app)/chat/components/room-composer.tsx>), [room-message-row.tsx](<../web/src/app/(app)/chat/components/room-message-row.tsx>), [rooms-client.tsx](<../web/src/app/(app)/chat/components/rooms-client.tsx>) |
