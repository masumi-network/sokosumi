...
- Active slice: Drive selection (16), draft PR [#4440](https://github.com/masumi-network/sokosumi/pull/4440), branch `codex/apple-chat-drive-picker`, based on main `27ebec3f5`. The approved Core schema prerequisite [#4432](https://github.com/masumi-network/sokosumi/pull/4432) merged as `27ebec3f5`; all its CI passed. Apple snapshot regenerated from that commit's deployed Core preview using the existing extraction script.
