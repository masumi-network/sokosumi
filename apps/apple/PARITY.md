...
- Next: complete SwiftSoup HTML sanitization/rendering and remaining language/visual parity checks. Markdown tree replacement and emoji conversion are integrated; no renderer PR yet.
