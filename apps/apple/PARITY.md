...
- Drive verification: 313 Chat tests, Xcode app tests, signed macOS build, and shared Workspace iOS 17 compilation passed. Fixtures omit pagination.total and decode files/folders across pages. Native menu and sheet open; the initial live check exposed #4432. The Mac locked during the corrected-build check, so live browse/search/select and sending remain unconfirmed. Composer stayed unchanged; nothing was sent.
