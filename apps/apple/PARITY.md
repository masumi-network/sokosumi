...
- Current rich-composer [PR #4388](https://github.com/masumi-network/sokosumi/pull/4388) is a draft on `codex/apple-chat-next-slice`. Implementation and verification are recorded under slice 12b below. Wait for review/merge before starting another slice.
