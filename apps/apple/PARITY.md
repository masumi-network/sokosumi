...
- Current slice: approved Xcode recommended project settings (27a) on `codex/apple-xcode-recommended-settings`: preserve the user's Xcode-applied dead-code stripping, inherited development team, and project-level String Catalog symbols. Local validation passes; next feature is chat start surface (28), only after this maintenance PR merges.
...
| 27a | Xcode recommended settings: dead-code stripping for project/app/tests, project-level development team inheritance, and project-level String Catalog symbol generation. User approved on 2026-09-16. | 27 | In progress — local validation passes; preparing PR | Native maintenance — `Sokosumi.xcodeproj/project.pbxproj`; existing app target already enables String Catalog symbols. |
