...
- Active slice: link unfurls (22), branch `codex/apple-chat-next-slice-4566`, based on `origin/main` at `ae1143d39b`. Implemented in draft [PR #4571](https://github.com/masumi-network/sokosumi/pull/4571); local validation complete, waiting for CI/review/merge.
...
| 22 | Link unfurls: title/description/image, open link, authorized remove action and errors. | 10 | Implemented — [#4571](https://github.com/masumi-network/sokosumi/pull/4571) | [room-message-row.tsx](<../web/src/app/(app)/chat/components/room-message-row.tsx>), [actions.ts](<../web/src/app/(app)/chat/actions.ts>) |
