...
- Slice 10 is implemented on `codex/apple-rich-message-rendering`, rebased on main `717b73d81`. Draft [PR #4384](https://github.com/masumi-network/sokosumi/pull/4384) is open; keep the row Partial until remaining interaction checks and review are complete. Earlier checkpoints below are historical.
