...
- Active slice: editing own messages (18), branch `codex/apple-edit-messages`, based on main after quotes #4477 merged. Draft [#4491](https://github.com/masumi-network/sokosumi/pull/4491). Reuses the existing Core PATCH endpoint and native rich composer; no contract or dependency change.
