...
- Active slice: file viewing parity (15), branch `codex/apple-file-viewing`, based on main `b7366d9b3`. Compact document tiles and native PDF viewing follow the user-approved split from #4440. Signed build, Xcode app tests (including native PDF fit/resize), SwiftFormat and SwiftLint passed. Live PDF loading verified; draft PR [#4469](https://github.com/masumi-network/sokosumi/pull/4469).
