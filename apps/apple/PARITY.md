...
- Verification: all 56 Workspace tests, seven ChatRefreshScheduler tests, Xcode app tests, SwiftFormat and strict SwiftLint pass. No production code, Core or web changes. Identify the Node caller before changing the Apple scheduler speculatively.
