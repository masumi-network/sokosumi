...
- Maintenance [PR #4385](https://github.com/masumi-network/sokosumi/pull/4385) merged as `e71173878`; all Apple CI jobs passed. Sources are grouped by feature and the coordinator lives in `SokosumiWorkspace`. Current branch: `codex/apple-rendering-verification`, based on that merge; draft [PR #4386](https://github.com/masumi-network/sokosumi/pull/4386) adds emoji composing.
