...
- Active slice: editing own messages (18), branch `codex/apple-edit-messages`, based on main after quotes #4477 merged. Reuses the existing Core PATCH endpoint and native rich composer; no contract or dependency change.
