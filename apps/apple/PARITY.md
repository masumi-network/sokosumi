...
- Message actions use React → Reply → Quote → More; Edit and Delete live in More with Delete last, separated. Existing action permissions and deletion confirmation remain in place.
