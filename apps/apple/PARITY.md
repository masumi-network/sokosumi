...
- Current slice: Browse channels (30), branch `codex/apple-browse-channels`, based on `cab2b95c8` (origin/main). Create channel #4675 is merged; its final Apple CI run 35116315977 passed. Browse implementation is locally verified in draft [#4677](https://github.com/masumi-network/sokosumi/pull/4677); awaiting CI/review and human merge.
