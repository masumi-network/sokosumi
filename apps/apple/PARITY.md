...
- Current slice: Browse channels (30), branch `codex/apple-browse-channels`, based on `cab2b95c8` (origin/main). Create channel #4675 is merged; its final Apple CI run 35116315977 passed. Browse implementation and verification are in progress; no PR yet.
...
| 30 | Browse discoverable channels, search/list/join and open joined room; respect workspace and visibility rules. | 07, 29 | In progress — local implementation | [browse-channels-dialog.tsx](<../web/src/app/(app)/chat/components/browse-channels-dialog.tsx>), [actions.ts](<../web/src/app/(app)/chat/actions.ts>) |
