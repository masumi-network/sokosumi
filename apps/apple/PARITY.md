...
- Active slice: attachment rendering (15), branch `codex/apple-chat-attachment-previews`, based on main `b94d66fd5e`. Reuses parsed Markdown/HTML links and native SwiftUI/AVKit presentation. No dependencies, Core contracts, or web code change. Drive selection (16) remains separate.
