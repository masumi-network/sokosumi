...
- Active slice: deleting own messages (19), branch `codex/apple-delete-messages`, based on main after editing #4491 merged. Draft [#4498](https://github.com/masumi-network/sokosumi/pull/4498). Reuses the existing Core DELETE endpoint and native confirmation alert; no contract or dependency change.
...
| 19 | Delete eligible messages with confirmation; preserve tombstones, thread context and authorization/error behavior. | 07, 08 | In review — [#4498](https://github.com/masumi-network/sokosumi/pull/4498) | [room-message-row.tsx](<../web/src/app/(app)/chat/components/room-message-row.tsx>), [rooms-client.tsx](<../web/src/app/(app)/chat/components/rooms-client.tsx>), [actions.ts](<../web/src/app/(app)/chat/actions.ts>) |
