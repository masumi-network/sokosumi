...
- Current slice: unified toolbar New chat picker (27b), [#4669](https://github.com/masumi-network/sokosumi/pull/4669), branch `codex/apple-chat-start`. User revised the scope on 2026-09-16: remove Welcome and the extra sidebar action for now; retain one toolbar picker with coworkers first, followed by people and the personal assistant. Local package, native-window, lint/format and iOS compatibility checks pass; revised-head CI remains pending.
