...
| 21 | Pinned messages: pin/unpin, list, loading/empty/error, jump to message and realtime updates. | 07 | In review — [#4549](https://github.com/masumi-network/sokosumi/pull/4549) | [pinned-messages-panel.tsx](<../web/src/app/(app)/chat/components/pinned-messages-panel.tsx>), [rooms-client.tsx](<../web/src/app/(app)/chat/components/rooms-client.tsx>), [actions.ts](<../web/src/app/(app)/chat/actions.ts>) |
