...
- Message actions use React → Reply → Quote → More; Edit and Delete live in More with Delete last, separated. Existing action permissions and deletion confirmation remain in place. Toolbar labels share scaled icon frames, callout text, consistent spacing and individual hover highlights; More retains a native menu. App tests and pinned lint/format passed.
