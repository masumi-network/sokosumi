...
- Current slice: Create channel (29), branch `codex/apple-create-channel`, based on latest origin/main. Implemented and locally verified in draft [#4675](https://github.com/masumi-network/sokosumi/pull/4675); awaiting CI/review and human merge.
...
| 29 | Create channel: name/slug availability, topic, discoverability, participants, step validation and errors. | 03, 06 | In progress ([#4675](https://github.com/masumi-network/sokosumi/pull/4675); awaiting merge) | [create-channel-dialog.tsx](<../web/src/app/(app)/chat/components/create-channel-dialog.tsx>), [create-channel-wizard.ts](<../web/src/app/(app)/chat/components/create-channel-wizard.ts>), [actions.ts](<../web/src/app/(app)/chat/actions.ts>) |
