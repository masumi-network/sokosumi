...
| 24a | Match web thread-row preview cleanup, mention names/fallbacks, address suppression and grapheme-safe 128-codepoint cap. Replace the earlier Markdown-flattening path; keep processing off the main thread. | 24 | In progress | [unread-threads-preview.ts](<../web/src/app/(app)/chat/utils/unread-threads-preview.ts>), [chat-message-preview.ts](../../packages/utils/src/chat-message-preview.ts) |
