...
import {
  ...
  sentryBrowserExtensionDenyUrls,
  sentryThirdPartyFetchIgnoreErrors,
...
Sentry.init({
  ...
  denyUrls: sentryBrowserExtensionDenyUrls,
  ignoreErrors: sentryThirdPartyFetchIgnoreErrors,
  beforeSend: beforeSendBrowserNoiseFilter,
