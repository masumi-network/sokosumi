...
import { filterThirdPartyAnalyticsClientEvent } from "@/lib/sentry/client-event-filters";
...
Sentry.init({
  ...
  ignoreErrors: [/^TypeError: Failed to fetch \(plausible\.io\)$/],

  denyUrls: [/plausible\.io/i],

  beforeSend: filterThirdPartyAnalyticsClientEvent,
