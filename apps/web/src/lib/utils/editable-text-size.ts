 ...
 * editables track Apple Dynamic Type with the rest of the UI. Do not use
 * `md:text-sm` or a px floor — root is capped at 1.25× (20px) via
 * DynamicTypeRootCap. iOS Safari focus zoom is blocked via viewport
 * `maximumScale: 1` (root + chat layouts), not a font-size floor.
