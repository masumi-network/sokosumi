...
export interface CoworkerDisplayPatchBody {
  name?: string;
  caption?: string | null;
  description?: string | null;
}

export type CoworkerImageIntent = "none" | "upload" | "remove";

export interface UpdateCoworkerDisplayInput {
  id: string;
...
export interface UpdateCoworkerDisplayResult {
  coworker: Coworker;
  imageError?: string;
}
...
export const coworkerDisplayService = (() => {
