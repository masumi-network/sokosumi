...
export type ClientOptions = {
    baseUrl: 'https://api.sokosumi.com/v1' | 'https://preprod.api.sokosumi.com/v1' | 'http://localhost:8787/v1' | (string & {});
};
...
export type GetUsersMeOrganizationsByIdData = {
    body?: never;
    path: {
        /**
...
export type GetUsersMeOrganizationsByIdErrors = {
    /**
     * Unauthorized
     */
    401: {
...
export type GetUsersMeOrganizationsByIdError = GetUsersMeOrganizationsByIdErrors[keyof GetUsersMeOrganizationsByIdErrors];

export type GetUsersMeOrganizationsByIdResponses = {
    /**
...
export type GetUsersMeOrganizationsByIdResponse = GetUsersMeOrganizationsByIdResponses[keyof GetUsersMeOrganizationsByIdResponses];
...
export type GetTasksData = {
    ...
    query?: {
        /**
         * Comma-separated status filters. Allowed values: DRAFT, READY, INPUT_REQUIRED, AUTHENTICATION_REQUIRED, OUT_OF_CREDITS, CREDITS_TOPPED_UP, RUNNING, AWAITING_EXTERNAL, COMPLETED, FAILED, CANCEL_REQUESTED, CANCELED. Example: READY,COMPLETED
         */
