 ...
 */
export const getAgentsFavorites = <ThrowOnError extends boolean = false>(options?: Options<GetAgentsFavoritesData, ThrowOnError>): RequestResult<GetAgentsFavoritesResponses, GetAgentsFavoritesErrors, ThrowOnError> => (options?.client ?? client).get<GetAgentsFavoritesResponses, GetAgentsFavoritesErrors, ThrowOnError>({
    responseTransformer: getAgentsFavoritesResponseTransformer,
    url: '/agents/favorites',
    ...options
});

/**
 * Add an agent to the authenticated caller's favorites
 */
export const postAgentsFavorites = <ThrowOnError extends boolean = false>(options?: Options<PostAgentsFavoritesData, ThrowOnError>): RequestResult<PostAgentsFavoritesResponses, PostAgentsFavoritesErrors, ThrowOnError> => (options?.client ?? client).post<PostAgentsFavoritesResponses, PostAgentsFavoritesErrors, ThrowOnError>({
    responseTransformer: postAgentsFavoritesResponseTransformer,
    url: '/agents/favorites',
    ...options,
    headers: {
...
/**
 * Remove an agent from the authenticated caller's favorites
 */
export const deleteAgentsFavoritesByAgentId = <ThrowOnError extends boolean = false>(options: Options<DeleteAgentsFavoritesByAgentIdData, ThrowOnError>): RequestResult<DeleteAgentsFavoritesByAgentIdResponses, DeleteAgentsFavoritesByAgentIdErrors, ThrowOnError> => (options.client ?? client).delete<DeleteAgentsFavoritesByAgentIdResponses, DeleteAgentsFavoritesByAgentIdErrors, ThrowOnError>({
    responseTransformer: deleteAgentsFavoritesByAgentIdResponseTransformer,
    url: '/agents/favorites/{agentId}',
    ...options
});
 ...
 */
export const getAgentsHired = <ThrowOnError extends boolean = false>(options?: Options<GetAgentsHiredData, ThrowOnError>): RequestResult<GetAgentsHiredResponses, GetAgentsHiredErrors, ThrowOnError> => (options?.client ?? client).get<GetAgentsHiredResponses, GetAgentsHiredErrors, ThrowOnError>({
    responseTransformer: getAgentsHiredResponseTransformer,
    url: '/agents/hired',
    ...options
});
