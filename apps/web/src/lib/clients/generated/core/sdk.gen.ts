 ...
 */
export const putOrganizationsByIdLogo = <ThrowOnError extends boolean = false>(options: Options<PutOrganizationsByIdLogoData, ThrowOnError>) => (options.client ?? client).put<PutOrganizationsByIdLogoResponses, PutOrganizationsByIdLogoErrors, ThrowOnError>({
    ...formDataBodySerializer,
    responseTransformer: putOrganizationsByIdLogoResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
