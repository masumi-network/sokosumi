 ...
 */
export const postHermesMeInstanceIntegrations = <ThrowOnError extends boolean = false>(options?: Options<PostHermesMeInstanceIntegrationsData, ThrowOnError>) => (options?.client ?? client).post<PostHermesMeInstanceIntegrationsResponses, PostHermesMeInstanceIntegrationsErrors, ThrowOnError>({
    responseTransformer: postHermesMeInstanceIntegrationsResponseTransformer,
    url: '/hermes/me/instance/integrations',
    ...options,
    headers: {
        'Content-Type': 'application/json',
