 ...
 */
export const postConversationsChat = <ThrowOnError extends boolean = false>(options?: Options<PostConversationsChatData, ThrowOnError, PostConversationsChatResponse>) => (options?.client ?? client).sse.post<PostConversationsChatResponses, PostConversationsChatErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
