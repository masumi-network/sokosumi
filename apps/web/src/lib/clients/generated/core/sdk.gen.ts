...
/**
 * Get a publicly shared job by share token
 */
export const getShareJobsByToken = <ThrowOnError extends boolean = false>(options: Options<GetShareJobsByTokenData, ThrowOnError>) => (options.client ?? client).get<GetShareJobsByTokenResponses, GetShareJobsByTokenErrors, ThrowOnError>({
    responseTransformer: getShareJobsByTokenResponseTransformer,
