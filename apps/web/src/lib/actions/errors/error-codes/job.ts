export enum JobErrorCode {
  ...
  JOB_PURCHASE_NOT_FOUND = "JOB_PURCHASE_NOT_FOUND",
  JOB_EVENT_NOT_FOUND = "JOB_EVENT_NOT_FOUND",
  JOB_SHARE_NOT_FOUND = "JOB_SHARE_NOT_FOUND",
  JOB_ALREADY_SHARED_PUBLICLY = "JOB_ALREADY_SHARED_PUBLICLY",
  JOB_ALREADY_SHARED_IN_ORGANIZATION = "JOB_ALREADY_SHARED_IN_ORGANIZATION",
