...
function createSimpleIconOrigin(pathD: string): TaskEventOriginIconComponent {
  return function SimpleIconOrigin({
    size,
    className,
    ...props
  }: TaskEventOriginIconProps) {
    return (
      <svg
        role="img"
        viewBox="0 0 24 24"
...
const SlackOriginIcon = createSimpleIconOrigin(SLACK_ICON_PATH);
const TeamsOriginIcon = createSimpleIconOrigin(TEAMS_ICON_PATH);
...
> = {
  [TaskEventOrigin.SLACK]: SlackOriginIcon,
  [TaskEventOrigin.TEAMS]: TeamsOriginIcon,
