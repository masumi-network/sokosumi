...
/**
 * Synthetic default category injected at runtime for agents without categories
 * in the database. Ensures filtering and grouping always have a fallback bucket.
 */
