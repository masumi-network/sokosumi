 ...
 *
 * Up to three 24px faces, overlapping. One face cannot say "several people
 ...
 * row's mark is 24px on the rail and its stack expanded, off the same edge.
 *
 * 24px per face rather than the 20px it used to be expanded: Inter's M and W
 * run about 40% wider than A or E, and a circle's usable width at cap height
 * is well short of its diameter, so at 20px a "MA" or "WM" fallback touched
 * the rim while "AT" sat fine. 24px holds every pair at the same 9px type.
 *
