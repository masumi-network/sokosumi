...
type OfferOutput = NonNullable<CoworkerOffer["outputs"]>[number];
type OutputKind = OfferOutput["type"];
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden border-b">
        <OfferThumb offer={offer} typeLabel={typeLabel} />
        {offer.category ? (
          <span
            className={cn(
