 ...
 * are solid, which makes Limited to High the step a reader notices. No tier
 ...
 * label would need 4.5:1, and no vivid amber reaches it on white. That
 * constraint is what turns amber into mud. The dot only needs 3:1 (WCAG 2.2
 * SC 1.4.11), so the colour stays vivid there instead.
 */
