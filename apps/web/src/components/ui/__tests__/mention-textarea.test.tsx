...
describe("MentionTextarea", () => {
  ...
  it("applies markdown wrap via the imperative handle", () => {
    const onChange = vi.fn();
    ...
    function WrapHarness() {
      ...
      return (
        <>
          <button
            type="button"
            onClick={() => textareaRef.current?.applyMarkdownWrap("bold")}
          >
            bold
          </button>
          <MentionTextarea
    ...
    editor.focus();
    // Select all serialized text so wrap targets "hello".
  ...
  it("opens the link shortcut callback on Cmd+K", () => {
