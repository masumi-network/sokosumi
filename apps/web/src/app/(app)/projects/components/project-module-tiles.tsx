    ...
    <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
      {calendarHref ? (
        <Link
          ...
          className="border-border/50 hover:border-primary/50 hover:bg-muted/50 focus-visible:border-ring focus-visible:ring-ring-halo flex min-w-0 flex-col rounded-xl border p-4 transition-colors outline-none focus-visible:ring-[3px]"
          href={calendarHref}
        >
