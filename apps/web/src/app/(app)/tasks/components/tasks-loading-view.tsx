  ...
  return (
    ...
    >
      <div className="flex flex-row items-center justify-between gap-3">
        <div>
          <div className="bg-card-background flex items-center gap-1 self-start rounded-lg p-1">
...
function TasksBoardLoading({ labels }: { labels: TasksLoadingLabels }) {
  return (
    <div className="-mx-2 flex h-full min-h-[calc(100svh-8.5rem)] w-full min-w-0 flex-1 items-stretch gap-3 overflow-x-auto overflow-y-hidden px-2 pb-4 [scrollbar-width:thin] [&::-webkit-scrollbar]:h-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-tertiary [&::-webkit-scrollbar-track]:bg-transparent">
