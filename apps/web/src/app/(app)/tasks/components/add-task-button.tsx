...
export function AddTaskButton({ label }: AddTaskButtonProps) {
  ...
  return (
    <button
      ...
      className="text-muted-foreground hover:text-muted-foreground hover:bg-card-background flex w-full items-center justify-center gap-1.5 rounded-md px-3 py-2 text-xs font-medium transition-colors"
    >
