...
export function JobListItem({ job, agentPreview, labels }: JobListItemProps) {
  ...
  return (
    <Link
      href={href}
      className="hover:bg-card-background flex flex-col gap-2 rounded-none px-4 py-3 transition-colors active:scale-[0.995] sm:grid sm:grid-cols-[minmax(0,1fr)_120px_160px_160px_120px] sm:items-center sm:gap-4"
    >
