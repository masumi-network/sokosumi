...
export function TaskRelationRow({
  ...
  return (
    <TaskDetailLink
      href={`/tasks/${taskId}`}
      className="bg-card-background border-border hover:bg-card-background-hover flex items-center justify-between gap-3 rounded-lg border p-3 transition-colors"
    >
