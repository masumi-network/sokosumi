...
interface VendorGrantMutationButtonsProps {
  organizationId: string;
  grantId: string;
  variant: "pending" | "active";
}

export function VendorGrantMutationButtons({
  organizationId,
  grantId,
  variant,
}: VendorGrantMutationButtonsProps) {
  ...
  return (
    <Button
      ...
      onClick={() =>
        runAction("revoke", () =>
          revokeOrganizationVendorGrant({ organizationId, grantId }),
        )
      }
    >
