 ...
 * has to put it back. iOS cannot take that write during a touch scroll. The
 * one child must be `shrink-0`, or the flex column clamps it to the
 * scroller's height and the list cannot scroll.
 */
