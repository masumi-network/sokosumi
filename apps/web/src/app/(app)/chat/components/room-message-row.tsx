  ...
  return (
    <div className="group/unfurl relative mt-1.5 inline-block w-fit max-w-[min(100%,25rem)]">
      <a
        ...
        className="border-border bg-card-background hover:bg-card-background focus-visible:ring-ring inline-block w-fit max-w-[min(100%,25rem)] overflow-hidden rounded-md border-l-2 border-l-primary/60 px-2.5 py-2 outline-none transition-colors focus-visible:ring-2"
