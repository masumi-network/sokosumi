...
import { tableViewDefinitionSchema } from "@sokosumi/utils";
import { saveTableView } from "@/helpers/data-table";
...
import { tableViewSchema } from "@/schemas/data-table.schema";
...
const route = withCoworkerContextHeaderParameters(
  createRoute({
    ...
    responses: {
      200: jsonSuccessResponse(tableViewSchema, "Table operation completed"),
