...
import mountDeleteChatRoomThreadMute from "./delete";
...
function createApp(authContext: AuthVariables["authContext"]) {
  ...
  app.use("*", async (c, next) => {
    c.set("requestId", "req_unmute_chat_room_thread");
...
describe("DELETE /chats/rooms/{id}/threads/{parentMessageId}/mute", () => {
  it("unmutes the thread for the caller and answers with it", async () => {
