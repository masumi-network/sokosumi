...
import mountGetChatRoomThreadAttention from "./[id]/thread-attention/get.js";
import mountPostChatRoomThreadAttentionRead from "./[id]/thread-attention/read/post.js";
...
mountGetChatRoomThreadAttention(app);
mountPostChatRoomThreadAttentionRead(app);
