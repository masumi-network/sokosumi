...
import { buildChannelMentionPrompt } from "./chat-channel-coworker-dispatch.service";
...
vi.mock("@/routes/v1/chat/coworker-conversation", () => ({
...
describe("buildChannelMentionPrompt", () => {
