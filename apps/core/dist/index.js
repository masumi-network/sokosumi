...
var errorResponseSchema = z.object({
  ...
  meta: z.object({
    ...
    timestamp: z.iso.datetime().openapi({ example: "2025-01-01T12:00:00.000Z" }),
    requestId: z.string().openapi({ example: "5091b3ea-994f-4417-8e04-2efc05dd8673" }),
...
import { createRoute, z as z5 } from "@hono/zod-openapi";
...
var successResponseSchema = (dataSchema) => z2.object({
...
var agentSchema = z4.object({
  id: z4.string().openapi({ example: "agent_123" }),
  name: z4.string().openapi({ example: "Research Assistant" })
}).openapi("Agent");

// src/routes/v1/agents/[id]/get.ts
var params = z5.object({
  id: z5.string().openapi({
...
import { createRoute as createRoute2, z as z6 } from "@hono/zod-openapi";
import { agentRepository as agentRepository2 } from "@sokosumi/database/repositories";
var agentsSchema = z6.array(agentSchema);
...
import { createRoute as createRoute3, z as z8 } from "@hono/zod-openapi";
import { userRepository } from "@sokosumi/database/repositories";

// src/routes/v1/users/schemas.ts
import { z as z7 } from "@hono/zod-openapi";
var userSchema = z7.object({
  id: z7.string().openapi({ example: "0Lm1hpg77w8g8QXbr3aEsFzX9aIUTybj" }),
  name: z7.string().openapi({ example: "John Doe" }),
  email: z7.string().openapi({ example: "john.doe@example.com" })
}).openapi("User");

// src/routes/v1/users/[id]/get.ts
var params2 = z8.object({
  id: z8.string().openapi({
    param: { name: "id", in: "path" },
